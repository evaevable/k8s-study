...
### 3.2 kube-apiserver：唯一的门，也是全集群的咽喉
...
### 3.4 kube-scheduler：只做一件事，就是"选址"
...
### 3.5 kube-controller-manager：一群"监工"的集合
...
### 3.6 工作节点三件套：kubelet / 容器运行时 / kube-proxy
