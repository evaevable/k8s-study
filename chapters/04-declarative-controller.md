...
### 4.4 控制器怎么"知道"状态变了：List、Watch 与 WorkQueue
...
### 4.6 resourceVersion 与乐观并发：两个控制器怎么不打架
...
### 4.7 对象图：为什么 Deployment 要转一手 ReplicaSet
