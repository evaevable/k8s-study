...
| 14 | [实战总演习：CloudNote 从 0 到 1](chapters/14-capstone.md) | 五阶段部署 + 六个故障演习 | 已发布 |
| 15 | [生产实践与排错手册](chapters/15-production.md) | 五层排查模型、症状对照表、40 项上线清单 | 已发布 |
| 附录 | [命令速查 + YAML 骨架 + 术语中英对照](chapters/appendix-cheatsheet.md) | 随时翻阅 | 已发布 |
